...
function setup() {
    ...
    for (let i = 0; i < centerCount; i++) {
        centers[i] = new Center([random(width/4, width/4 + width/2), random(height/4, height/4 + height/2)], [random(100, 220), random(100, 220),0], random(growthRate, growthRate + growthRange));
    }
}
...
Center.prototype.grow = function() {
    ...
    this.color[0] -= 1/2/growthRate;
    this.color[1] -= 1/2/growthRate;
}
